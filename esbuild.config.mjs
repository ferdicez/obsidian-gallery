...
// Esta pasta (plugins/obsidian-galeria-de-cards) é o código-fonte de desenvolvimento. O Obsidian carrega
// o plugin de dentro de .obsidian/plugins/gallery (pasta real do vault) — são pastas separadas, não a mesma.
// Sem essa cópia, o build fica "pronto" mas o Obsidian continua rodando a versão antiga.
const raiz = path.dirname(fileURLToPath(import.meta.url));
const pastaVaultPlugin = path.join(raiz, "..", "..", ".obsidian", "plugins", "gallery");
